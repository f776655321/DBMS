from matcher import column_matcher, FileRowMatcher
...
if __name__ == '__main__':
    ...
    foreign_column = col_matcher.get_column_matching(tables[0], tables[1], primary_key)

    row_matcher = FileRowMatcher()

    row_matcher.find(args.output_file, foreign_column, primary_key, foreign_file, primary_file)
